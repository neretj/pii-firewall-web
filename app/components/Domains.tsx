...
const domains = [
  {
    ...
    label: "Healthcare",
    color: "var(--accent3)",
    tagline: "Keep clinical context. Strip patient identifiers.",
    ...
    transforms: [
      ...
      { action: "REDACT", entity: "SSN / DNI", example: "123-45-6789 → [REDACTED]" },
      { action: "GENERALIZE", entity: "AGE", example: "43 → [AGE_40-49]" },
      { action: "MASK", entity: "PHONE", example: "555-1234 → 555-****" },
    ],
    codeInput: `"Paciente Ana García, 43 años, hipertensión.\nPrescripción: enalapril 10mg."`,
    codeOutput: `"Paciente PERSON_1, [AGE_40-49], hipertensión.\nPrescripción: enalapril 10mg."`,
  },
  {
    id: "finance",
    icon: "💼",
    label: "Finance",
    color: "#ffd166",
    tagline: "Keep amounts and transaction context. Protect account data.",
    keeps: ["Company names", "Transaction amounts & rates", "Currency codes"],
    transforms: [
      { action: "MASK", entity: "CREDIT_CARD", example: "4111...1111 → 4111...1111" },
  ...
  },
  {
    ...
    label: "Legal",
    color: "var(--accent)",
    tagline: "Maximum anonymity for parties. Public records pass through.",
    ...
    codeInput: `"El demandante Juan Pérez presentó recurso\nel 15 de marzo de 2024, exp. EXP-2024/001234."`,
    codeOutput: `"El demandante PERSON_1 presentó recurso\nen 2024, exp. EXP-2024/001234."`,
  },
  {
    id: "generic",
    icon: "🌐",
    label: "Generic",
    color: "var(--accent2)",
    tagline: "Sensible defaults. The best starting point for custom profiles.",
    ...
    transforms: [
      ...
      { action: "REDACT", entity: "IDs", example: "SSN, passport → [REDACTED]" },
    ],
